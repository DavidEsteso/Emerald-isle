//
// Created by david on 23/12/2024.
//
...
struct Sphere : public Entity {
    ...
    void initialize(glm::vec3 pos, glm::vec3 scl) {
        ...
        const char* modelPath = "../lab2/models/sphere/15977_Sphere_with_Grid_v1.obj";
        ...
        // Load shaders
        programID = LoadShadersFromFile("../lab2/shaders/sphere.vert", "../lab2/shaders/sphere.frag");
        if (programID == 0) {
