...
struct Spire : public Entity {
    ...
    void initialize(glm::vec3 pos, glm::vec3 scl) {
        ...
        // Load shaders
        programID = LoadShadersFromFile("../lab2/shaders/spire.vert", "../lab2/shaders/spire.frag");
        if (programID == 0) {
        ...
        diffuseTexture = LoadTexture(texturePath + "painted_concrete_02_diff_1k.jpg");
        normalTexture = LoadTexture(texturePath + "painted_concrete_02_nor_gl_1k.png");
        //roughnessTexture = LoadTexture(texturePath + "painted_concrete_02_rough_1k.png");
